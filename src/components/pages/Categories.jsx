...
const ObjList = [
    ...
    id:1,
    name:'Ticket',
    path:  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.5 12A2.5 2.5 0 0 1 21 9.5V7a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v2.5a2.5 2.5 0 0 1 0 5V17a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-2.5a2.5 2.5 0 0 1-2.5-2.5Z"/>
    },
    {
    id:1,
    name:'Ticket',
...
export default  function Categories() {
  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
      ...
      {/* navigate to page */}
      <a href="#" title="" class="flex items-center text-base dark:text-white font-medium text-primary-700 hover:underline dark:text-primary-500">
        See more categories
        {/* right arrow  */}
...
function Card(){
  return(
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {ObjList.map((item)=>(
         <div>          
          <a href="#" class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" key={item.id}>
