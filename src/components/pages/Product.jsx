...
const ObjList = [
  {id:1,
    ...
    img:{
      dark:'"https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"',
      light:"https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg",
    },
    alt:'',
    price:'1,200',
    discount:'20',
      ...
      {ObjList.map((item)=>(
       <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src={item.img.dark} alt={item.alt} />
            <img class="mx-auto hidden h-full dark:block" src={item.img.light} alt={item.alt} />
          </a>
        </div>
        <div class="pt-6">
          <div class="mb-4 flex items-center justify-between gap-4">
            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Up to {item.discount}% off </span>
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{item.name}</a>
