...
// navabr 
const MenuList = ['Home','Best Sellers','Gift Ideas','Today Deals','Sell']
const BrandLogoLight = 'https://flowbite.s3.amazonaws.com/blocks/e-commerce/logo-full.svg'
const BrandLogoDark = 'https://flowbite.s3.amazonaws.com/blocks/e-commerce/logo-full-dark.svg'
...
export default function Navbar() {
  ...
  <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
    <div class="flex items-center justify-between">
      ...
      {/* navabr brand logo */}
          <a href="#" title="" class="">
            <img class="block w-auto h-8 dark:hidden" src={BrandLogoLight} alt=""/>
            <img class="hidden w-auto h-8 dark:block" src={BrandLogoDark} alt=""/>
          </a>
        </div>
        {/* navbar menu item */}
